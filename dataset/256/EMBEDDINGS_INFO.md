...
- **Birleştirilmiş Embedding Boyutu**: 512

## Oluşturulan Verisetleri

| Dosya | Açıklama | Boyut |
|-------|----------|-------|
| train_title_embeddings.npz | Eğitim - Başlık embeddinglari | (6250, 256) |
| train_abstract_embeddings.npz | Eğitim - Özet embeddinglari | (6250, 256) |
| train_concat_embeddings.npz | Eğitim - Birleştirilmiş embeddingler | (6250, 512) |
| test_title_embeddings.npz | Test - Başlık embeddinglari | (6250, 256) |
| test_abstract_embeddings.npz | Test - Özet embeddinglari | (6250, 256) |
| test_concat_embeddings.npz | Test - Birleştirilmiş embeddingler | (6250, 512) |
...
- **PCA ile Düşürülmüş Boyut**: 256
- **Concat Embedding Boyutu**: 512 (256 + 256)
...
- PCA modelleri train verisi üzerinden eğitilmiş, hem train hem test verisine uygulanmıştır.
